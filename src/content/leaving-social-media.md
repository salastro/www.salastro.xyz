...
In my opinion, how people use social media today can't be more toxic. We don't really engage, have fun, or learn. You waste hours of your life doing nothing but scroll through an endless stream of meaningless content. Human lives should be wasted on nothing like this. I won't be talking about ***why to leave***, you are here because you already want to leave.

## Why it's so hard to leave

Social media companies improve their products every single day, and part of that improvement is measured in time on platform, which is why the average user burns countless hours there. Their goal is to make you always use their product, no matter your mental state. You are happy? Let's share your happiness with the world! Sad? Let's browse whatever may make you happy! And the list goes on. We are weak humans with powerful lusts controlling us, up against huge corporations that search for everything in human nature they can exploit for profit, which is, unfortunately, harmful to us in this case.

## What we should do

The approach I use depends on the fundamental idea that humans have no self-control. The only thing that may prevent us from harming ourselves is how hard it is. Thus, we shouldn't *try* to stop using social media; we should make every social media platform we use **unusable**. The notion that willpower alone can move mountains is, more often than not, a fantasy. Humans weren't created to do the hardest thing in front of them, quite the opposite, the easiest possible thing they could think of. Conserving energy was the way to go for survival for cavemen, so we were built to choose the path that costs the least energy. Modern life demands a lot of energy on things cavemen were never used to, and that's where the conflict between our conscious mind and our primal brain comes from.
